...
<div class="constitution">
    ...
    <h3 class="noUnderscore clickable" onclick={() => goToSection(one)}>Section 1: Roster</h3>
       ...
       <!-- <h5 class="noUnderscore clickable" onclick={() => goToSection(oneTwoOne)}>1.2.1 Trade Collusion</h5>
            ...
            <h5 class="noUnderscore clickable" onclick={() => goToSection(oneTwoTwo)}>1.2.2 Trade Restrictions</h5>
   <!--     <h5 class="noUnderscore clickable" onclick={() => goToSection(oneTwoThree)}>1.2.3 Veto/Trade Process</h5> -->
...
<!--    <h4 bind:this={oneTwoFive}>1.2.3 Veto/Trade Process</h4>
    ...
    <p>Rookie drafts will consist of 4 rounds of drafting, with 5 minutes alotted for each pick. You're allowed to have an illegal roster to accomodate these picks until it's time to set your lineups at the start of the year.</p>
    <p>Any spots not filled during the draft, can be filled from the waiver wire a few days after the draft to give people a chance to scout waivers and put in claims.</p>
